...
You can also add the `spindle_rs=off` value to the RUST_LOG environment variable to see the logs from [spindle-rs](https://github.com/flowerinthenight/spindle-rs).
